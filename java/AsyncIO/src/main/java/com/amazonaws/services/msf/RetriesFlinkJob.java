...
/**
 * A sample Managed Service For Apache Flink application with a Data Gen source
 * and Kinesis data streams sink
 * with Async I/O demonstrating retries.
 */
public class RetriesFlinkJob {
        ...
        public static void main(String[] args) throws Exception {
                ...
                DataStream<ProcessedEvent> processedStream = AsyncDataStream.unorderedWaitWithRetry(
                                source,
                                new ProcessingFunction(applicationParameters.get("EndpointService")),
                                2000, // Timeout
