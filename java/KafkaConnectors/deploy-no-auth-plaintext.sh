...
stack_name=flink-kafka-no-auth-plaintext
application_name=flink-kafka-no-auth-plaintext
template_file=cloudformation/template-no-auth-plaintext.yaml
region=ap-south-1

source_kafka_bootstrap_server="b-1.mskprovisioned2.xe3lni.c3.kafka.ap-south-1.amazonaws.com:9092,b-2.mskprovisioned2.xe3lni.c3.kafka.ap-south-1.amazonaws.com:9092,b-3.mskprovisioned2.xe3lni.c3.kafka.ap-south-1.amazonaws.com:9092"
source_topic=flink-kafka-sample-src
sink_kafka_bootstrap_server="b-1.mskprovisioned2.xe3lni.c3.kafka.ap-south-1.amazonaws.com:9092,b-2.mskprovisioned2.xe3lni.c3.kafka.ap-south-1.amazonaws.com:9092,b-3.mskprovisioned2.xe3lni.c3.kafka.ap-south-1.amazonaws.com:9092"
