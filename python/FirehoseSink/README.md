...
The delivery stream name is defined in the configuration (see [below](#runtime-configuration)), by default is 
`ExampleOutputFirehoseStream` in `us-east-1`.

The destination where the delivery stream write data and the destination settings are not relevant. 
...
|-----------------|---------------|---------------------------------------|----------------------------------------|
| `OutputDeliveryStream0` | `stream.name` | `ExampleOutputFirehoseDeliveryStream` | Output delivery stream .               |
| `OutputDeliveryStream0` | `aws.region`  | `us-east-1`                           | Region for the output delivery stream. |
